...
X_train_df = pd.DataFrame(X_train_vect, columns=np.arange(100)).set_index(X_train.index.values)
X_submission_df = pd.DataFrame(X_submission_vect, columns=np.arange(100)).set_index(X_submission.index.values)
