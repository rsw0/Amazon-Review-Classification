...
clf = RandomForestClassifier(max_depth = 8, n_estimators = 30, min_sample_split = 200, max_samples = 0.2, max_features = 3, min_samples_leaf = 50, n_jobs = -1, oob_score = True, class_weight='balanced_subsample', random_state=0)
